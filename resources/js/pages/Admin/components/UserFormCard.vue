...
<template>
    ...
    >
        <div class="space-y-5">
            ...
            <div class="space-y-1.5">
                ...
                <input
                    ...
                    "
                />
                <p v-if="props.form.errors.name" class="text-xs text-red-500">
            ...
            <div class="space-y-1.5">
                ...
                <input
                    ...
                    "
                />
                <p v-if="props.form.errors.email" class="text-xs text-red-500">
            ...
            <div class="space-y-1.5">
                ...
                <p v-if="props.form.errors.role" class="text-xs text-red-500">
                    {{ props.form.errors.role }}
                </p>
            </div>
        </div>
        ...
        >
            <p v-if="props.form.wasSuccessful" class="text-xs text-green-600">
                Desat correctament.
            </p>
            <div v-else />
            <button
