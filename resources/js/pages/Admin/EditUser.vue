        ...
        <div class="flex flex-1 flex-col lg:flex-row">
            ...
            <main class="flex-1 px-8 py-12 sm:px-12 lg:px-20 flex items-start justify-center lg:justify-start">
                <div class="w-full max-w-md space-y-7">
                    <div>
                        <h1 class="text-lg font-semibold text-gray-900">Editar usuari</h1>
                    </div>
                    <div class="space-y-5">
                       ...
                       focus:bg-white focus:border-gray-300 focus:ring-0 hover:bg-gray-100" />
                        </div>
                        <div class="space-y-1.5">
                    ...
                    <div class="flex items-center justify-between pt-2">
                        <p v-if="form.wasSuccessful" class="text-xs text-teal-500 flex items-center gap-1.5">
