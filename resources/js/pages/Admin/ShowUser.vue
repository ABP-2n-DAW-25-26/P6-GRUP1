        ...
        <div class="grid gap-6 lg:grid-cols-4">
            ...
            >
                <div class="flex flex-col items-center text-center">
                    ...
                    <h2 class="mt-4 text-lg font-semibold text-hp-text">
                        {{ user.name }}
                    </h2>
                    <p class="mt-1 text-sm text-hp-text-dim">
                        {{ user.email }}
                ...
                <div
                    class="mt-6 space-y-2 border-t border-gray-100 pt-4 text-sm text-hp-text-dim"
                >
                    <p>
                        <span class="font-medium text-hp-text">ID:</span>
                        {{ user.id }}
                    </p>
                    <p>
                        <span class="font-medium text-hp-text">Registrat:</span>
                        {{
            ...
            <div class="space-y-6 lg:col-span-3">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    >
                        <p class="text-2xl font-bold text-hp-text">
                    ...
                    <div
                        class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm"
                    >
                        <p class="text-2xl font-bold text-hp-text capitalize">
                            {{ user.role }}
                        </p>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div>
                                <p class="font-medium text-hp-text">
                                    {{ ex.title }}
                                </p>
                    ...
                    <div
                        v-else
                        class="px-6 py-8 text-center text-sm text-hp-text-dim"
                    >
